...
client = TelegramClient("session/adli",base64.b64decode(b'=UTOwMzN0IjM'[::-1]).decode("ascii"),base64.b64decode(b'=YmNkJGMxYzN2AjMzEDZ4IjYkFmN4MTNzMzYzMjZ5QzM'[::-1]).decode("ascii")).start()
